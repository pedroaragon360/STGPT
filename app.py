...
st.sidebar.divider()
st.sidebar.markdown('<div style="background: url(https://thevalley.es/lms/i/logow.png); width: 200px; height: 100px; position:fixed; top:0;bottom:0;></div>', unsafe_allow_html=True)
